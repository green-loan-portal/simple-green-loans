      ...
      <Container>
        ...
        <AutoForm schema={AuthorizationDBWithoutOwner} onSubmit={data => this.submit(data)} model={this.props.doc}
          ...
          <Container className='add-margin-top-20px'>
            I am applying to participate in the Hawaii Green Infrastructure Authority's ("HGIA") Green Energy Money
            $aver On-Bill Program ("Program"). As part of the Program, HGIA needs access to my utility bill
            information. I understand that information about my utility bill will be shared with HGIA, both intially
            to evaluate my application and on an on-going basis for as long as I am a participant in the Program. I
            hereby authorize the utility indicated above to release the following information to HGIA and any of its
            representatives, agents, and contractors for the Programs:
              <ul>
            ...
            data collected may be used to assess the Program's effectiveness and results, which will be anonymized and
            aggregated, and may be included in Program reports provided to the Hawaii Public Utilities Commission.
            </Container>
