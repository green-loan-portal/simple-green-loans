...
class EditForm6 extends React.Component {

  submit(data) {
    const { income, totalOccupants, numAdults, numRetired, numChildrenBelow5, numChildren6to12, numChildren13to17,
      membersNotHomeDay, membersNotHomeNight, membersHomeDay, membersHomeWork, employerName, occupation, workPhone, _id } = data;
...
export default withTracker(({ match }) => {
  ...
  return {
    doc: Section6DB.findOne(documentId),
