...
import {
  Section1DBSchemaWithoutOwner,
  Section1DB
} from '/imports/api/stuff/Section1DB';
...
class Form1 extends React.Component {
  ...
  render() {
    ...
    return (
        <Container>
          <AutoForm
              schema={Section1DBSchemaWithoutOwner}
          ...
          >
            ...
            <SelectField checkboxes name="howDidYouHearAboutUs" label={false}/>
            <Form.Group>
              <TextField name="otherHDYHA" label={false} placeholder={"Other"}/>
            </Form.Group>
            ...
            <h3>
              Which energy savings product(s) would you most likely be interested
              in installing within the next three (3) years?
            </h3>
            <SelectField checkboxes name="interestedInInstalling" label={false}/>
            <Form.Group>
              <TextField
            ...
            <h3>
              Where are you most likely to go to get assistance or training
              regarding managing energy costs and finances?
            </h3>
            <SelectField checkboxes name="assistanceFrom" label={false}/>
            ...
            <h3>
              Is there anyone you know that could benefit from lowering their
              energy costs?
            </h3>
