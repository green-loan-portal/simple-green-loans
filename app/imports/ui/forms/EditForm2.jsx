...
class EditForm2 extends React.Component {

  submit(data) {
    const {
      firstName, middleName, lastName, utilityAccountNumber, energyImprovementOptions, metWithApprovedContractor,
      contractorName, contactName, streetAddress, islandLocation, residenceType, _id
    } = data;

    Section2DB.update(_id, {
      $set: {
      ...
      if (error) {
        ...
        swal('Success', 'Section #2-5 updated successfully', 'success');
      }
    });
  }
...
export default withTracker(({ match }) => {
  ...
  return {
    doc: Section2DB.findOne(documentId),
